...
//         public async Task<IActionResult> Get (int? pageIndex = 0, int? pageSize = 15, String zoningName = null)
//         {
...
//             return Created($"api/Shops/{entity.Id}", Mapper.Map<DTO.Zoning>(entity));
//         }
